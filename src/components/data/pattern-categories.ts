...
export const patternCategories: Record<string, PatternCategory> = {
  general: {
    ...
    description:
      'Common UI patterns and interactions used across most applications, including actions, navigation, filtering, and error handling.',
    patterns: [
      {
        id: 'general-actions',
        name: 'Actions',
  ...
  'generative-ai': {
    ...
    description:
      'Specialized patterns for AI-powered features including conversational interfaces, content generation, and AI-assisted workflows.',
    patterns: [
      {
  ...
  'resource-management': {
    ...
    description:
      'Patterns for managing resources and data entities, including CRUD operations, workflows, and resource lifecycles.',
    patterns: [
      {
  ...
  layout: {
    ...
    description:
      'Structural patterns for organizing content and components, including tables, forms, and page layouts.',
    patterns: [
      {
...
export function getPatternCategories(
  options: { includePatternCount?: boolean; includePatternList?: boolean; tags?: string[] } = {},
): PatternCategory[] {
